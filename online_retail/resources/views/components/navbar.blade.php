      ...
      <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        ...
        <li class="relative group">
            ...
            <div class="absolute left-0 z-50 hidden bg-white border rounded-lg shadow-md group-hover:block dark:bg-gray-800 dark:border-gray-700">
                <a href="{{ route('shop.category', 'action') }}" class="block px-4 py-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Action</a>
                <a href="{{ route('shop.category', 'adventure') }}" class="block px-4 py-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Adventure</a>
                <a href="{{ route('shop.category', 'rpg') }}" class="block px-4 py-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">RPG</a>
                <a href="{{ route('shop.category', 'strategy') }}" class="block px-4 py-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Strategy</a>
            </div>
        </li>
      </ul>
    </div>
